...
export const ForgetPasswordForm = () => {    
    ...
    const { error, isLoading, handleAuthReqPasswordReset} = useAuthReqPasswordReset() ;
    ...
    return (
        ...
        >
            <div className="form-container  w-[90%] min-[500px]:w-95 m-auto  ">
                ...
                <form className="forget-password-form font-[Inter] tracking-normal w-full" onSubmit={(e) => handleSubmit(e)}>
