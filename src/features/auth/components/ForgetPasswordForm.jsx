    ...
    return (
        ...
        >
            <div className="form-container  w-[90%] min-[500px]:w-95 m-auto  ">
                ...
                <form className="forget-password-form font-[Inter] tracking-normal w-full">
                    ...
                    <div className="forget-password-input-container relative w-full  mt-2 mb-10" >
                        ...
                        className="forget-password-input border border-[#E5E7EB] rounded-sm w-full py-4 pl-11" 
                        /> 
                    </div>
