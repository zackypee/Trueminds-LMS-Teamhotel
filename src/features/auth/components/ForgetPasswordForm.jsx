    ...
    return (
        ...
        >
            <div className="form-container  w-[90%] min-[500px]:w-95 m-auto  ">
                ...
                <form className="forget-password-form font-[Inter] tracking-normal w-full" onSubmit={(e) => {
                    e.preventDefault() ;
                    ...
                    <div className="forget-password-input-container relative w-full  mt-2 mb-10" >
                        <img src={emailIcon} alt="Email icon"  className="reset-mail-icon absolute top-[41%] left-[5%] "/>
                        <input type="email" id="email" name="email" required placeholder="email@example.com" 
                        className="forget-password-input border border-[#E5E7EB] rounded-sm w-full py-4 pl-11 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]" 
                        /> 
                    </div>
