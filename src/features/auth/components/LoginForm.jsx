        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border ${errors.email ? 'border-red-500' : 'border-[#D1D5DB]'} rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-[#06020e] focus:border-transparent`}
            />
            {errors.email && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                placeholder="********"
                className={`w-full border ${errors.password ? 'border-red-500' : 'border-[#D1D5DB]'} rounded-md p-3 pr-10 focus:outline-none focus:ring-2 focus:ring-[#06020e] focus:border-transparent`}
              />
              <button
                type="button"
...
//     e.preventDefault();
//     setErrors({});
//     await authLogin(formData.email, formData.password, setErrors);
//   };
...
//           {/* API / network errors from context */}
//           {error && (
//             <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-2 rounded-md text-sm">
//               {error}
//             </div>
...
//           {/* General field error (e.g. invalid credentials from API) */}
//           {errors.general && (
//             <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-2 rounded-md text-sm">
//               {errors.general}
//             </div>
...
//               } rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-[#06020e] focus:border-transparent`}
//             />
//             {errors.email && (
//               <p className="text-red-500 text-xs mt-1">{errors.email}</p>
//             )}
...
//                 } rounded-md p-3 pr-10 focus:outline-none focus:ring-2 focus:ring-[#06020e] focus:border-transparent`}
//               />
//               <button
//                 type="button"
//                 onClick={togglePasswordVisibility}
