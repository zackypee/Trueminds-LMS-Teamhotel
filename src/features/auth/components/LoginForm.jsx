      ...
      <div className="max-w-md mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#0029F5] text-white py-3 rounded-md font-semibold hover:bg-[#6D2ED9] cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <div className="text-center pt-4">
            ...
            <button
              ...
              className="text-[14px] font-bold text-[#64748B] hover:underline cursor-pointer mb-30"
            >
              Sign up
            </button>
          </div>
