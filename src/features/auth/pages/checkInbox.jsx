...
<span className="text-[#1F2937] font-semibold text-[14px]"> user.user@emailcom </span>
...
inputMode="numeric"
 className="border rounded font-bold w-full px-2 py-4 border-[#E5E7EB]" placeholder="6-digit-code" />

<button className="bg-[#7C3AED] text-white rounded w-full py-4 cursor-pointer">Log in</button>
...
<p className="text-[#7C3AED] text-center md:text-center font-semibold">Log into a different account</p>
