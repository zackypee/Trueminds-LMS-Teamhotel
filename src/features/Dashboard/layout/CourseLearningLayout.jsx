...
//       {/* NavBar */}
//       <UserDashboardNavbar onMenuClick={() => setIsSidebarOpen(!isSidebarOpen)} />
...
//         {/* Sidebar */}
//         <div className={`
//           fixed lg:relative z-50 bg-white border-r border-gray-200 h-screen overflow-y-auto transition-transform duration-300
...
// import { useState } from "react";
// import { Outlet } from "react-router-dom";
// import UserDashboardNavbar from "../../Dashboard/components/UserDashboardNavbar";
// import CourseSidebar from "../components/CourseSidebar";
...
//   const toggleSidebar = () => {
//     console.log("Toggle sidebar clicked", !isSidebarOpen); // Debug log
...
//         <div className={`
//           fixed lg:relative top-16 left-0 z-50 bg-white border-r border-gray-200 h-[calc(100vh-4rem)] overflow-y-auto transition-transform duration-300
//           ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
//           w-80
//         `}>
