    ...
    <div className="flex flex-col flex-1 bg-white">
      ...
      <div className="px-4 md:px-6 py-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div>
            <h1 className="text-[24px] md:text-[36px] font-bold text-[#001C3B]">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="bg-[#FFDBCC] rounded-2xl w-full md:max-w-[300px] px-6 py-6 flex flex-col gap-4">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#D97706] font-semibold text-[20px] md:text-[24px] leading-tight">
                  Pending Feedback
                </p>
                <p className="text-sm text-[#7B2F00] mt-1">
                  12 Assignments waiting
                </p>
              </div>
              <span className="bg-[#D97706] text-white text-[16px] font-extrabold px-2.5 py-1 rounded-lg">
                12
              </span>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-[#ffe9e0] rounded-xl px-4 py-3 flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-[#001C3B]">
                    Intro to UX De…
                  </p>
                  <p className="text-xs text-[#351000]">
                    4 submissions from Unit 2
                  </p>
                </div>
