...
const { onHandleLogout } = useLogoutUser();
  ...
  const menuItems = [
    ...
    {
      path: "assignments",
      icon: "M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.875 0h2.25m-2.25 3.75h2.25m-2.25 3.75h2.25M9 13.5h2.25m-2.25 3.75h2.25",
      label: "Assignments",
    },
    {
      path: "progress",
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full ">
          ...
          <div className="lg:hidden px-4 py-3 flex items-center justify-between border-b border-gray-200">
            <h1 className="text-[24px] font-bold text-[#1E3A5F] leading-none">
          ...
          <div className="p-4 border-t border-gray-200 flex flex-col gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-3 w-full px-3 py-2 rounded-lg transition-colors text-gray-600 hover:bg-red-50 hover:text-red-500 ${isCollapsed ? "lg:justify-center" : ""}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
