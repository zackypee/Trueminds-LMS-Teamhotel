...
const UserSidebarPanel = ({ isOpen, onClose, isCollapsed, setIsCollapsed, adjustSideBar }) => {
  ...
  const menuItems = [
    ...
    { path: 'courses', icon: 'M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25', label: 'Courses' },
    { path: 'assignments', icon: 'M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.875 0h2.25m-2.25 3.75h2.25m-2.25 3.75h2.25M9 13.5h2.25m-2.25 3.75h2.25', label: 'Assignments' },
