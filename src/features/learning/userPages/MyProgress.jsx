...
export default function MyProgress(){
  ...
  const filteredItems = activeTab === "All Courses"
    ? items
    : items.filter(i => i.status === activeTab)

  return(
    <>
      <div className="sticky top-16 z-10 px-5 md:px-10 pt-5 mb-5 pb-2 md:pb-5 bg-[#1E3A5F]">
      ...
      <div className="mx-5 md:mx-10 mt-8 mb-20">
        <div className="flex flex-col md:border md:border-[#E5E7EB] shadow-sm md:flex-row md:justify-between">
          <div className="border px-4 py-5 md:border-0 border-[#E5E7EB] rounded">
            ...
            <p className="text-[13px] md:text-[14px] text-[#6B7280]">Let's chip away at your learning goals.</p>
          </div>
          <div className="border md:border-0 border-[#E5E7EB] py-4 px-4 md:gap-40 flex items-center justify-between rounded">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-[12px] text-[#1F2937]"><strong className="text-lg">0</strong> Weeks</span>
                <span className="text-[12px] md:text-[14px] text-[#6B7280]">Current streak</span>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-1 items-center">
                  ...
                  <p className="text-[12px] md:text-[14px] text-[#1F2937]"><strong>0</strong>/30 course min</p>
                  <MdErrorOutline className="text-[#6B7280] text-lg"/>
                </div>
                <div className="flex gap-2 items-center">
                  <p className="w-2 h-2 rounded-full bg-[#16A34A]"></p>
                  <p className="text-[12px] md:text-[14px] text-[#1F2937]"><strong>1</strong>/1 visit</p>
                </div>
                <p className="text-[12px] md:text-[14px] text-[#1F2937]">March 22 - 29</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="flex gap-4 mt-4 shadow-sm border px-4 py-5 border-[#E5E7EB] rounded">
          ...
          <div>
            <h2 className="font-semibold mb-2 md:text-[20px] text-[18px] text-[#1F2937]">Schedule learning time</h2>
            <p className="text-[13px] text-[#6B7280] md:w-[80%]">Learning a little each day adds up. Research shows that students who make learning a habit are more likely to reach their goals. Set time aside to learn and get reminders using your learning scheduler.</p>
            <div className="gap-4 flex mt-4">
              <button className="font-semibold rounded text-[#0029F5] py-2 px-4 border-2 border-[#0029F5]">Get Started</button>
          ...
          <div className="md:flex md:justify-between md:items-center">
            <div className="flex gap-2 md:w-full">
              <div className="flex gap-2 border bg-[#F9FAFB] items-center rounded-4xl px-4 py-2 border-[#E5E5E5]">
                <IoFilter />
                <p className="font-semibold text-[13px] md:text-[14px] text-[#1F2937]">All Filters</p>
              </div>
              <div className="flex gap-2 border bg-[#F9FAFB] items-center rounded-4xl px-4 py-2 border-[#E5E5E5]">
                <p className="font-semibold text-[13px] md:text-[14px] text-[#1F2937]">Categories</p>
            ...
            <div className="flex gap-2 mb-4 border w-full md:flex-row-reverse items-center rounded-lg mt-4 px-4 py-4 border-[#E5E5E5]">
              ...
              <input className="outline-0 w-full" type="text" placeholder="Search my course" />
            </div>
          </div>
          <div className="flex mb-10 md:mb-2 justify-between items-center">
            <p className="text-[13px] md:text-[14px] text-[#1E3A5F]">{filteredItems.length} courses</p>
            <div className="flex items-center">
              <p className="text-[13px] md:text-[14px] font-semibold text-[#1E3A5F]">Recently Accessed</p>
              <RiArrowDropDownLine className="text-2xl" />
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 md:gap-4">
          {filteredItems.length > 0 ? filteredItems.map(i => (
            <div key={i.name} className="flex relative flex-col gap-4 mt-4 shadow-lg rounded-b-xl">
              <div>
              ...
              <div className="px-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-[13px] md:text-[14px] text-[#6B7280]">{i.lesson}</p>
                </div>
                <button className="bg-[#0029F5] mb-4 mt-4 py-3 rounded font-semibold text-white w-full">Continue Learning</button>
              </div>
            </div>
          )) : (
            <p className="text-[#6B7280] mt-4 col-span-3 text-center">No courses in this category.</p>
          )}
        </section>
      </div>
    </>
