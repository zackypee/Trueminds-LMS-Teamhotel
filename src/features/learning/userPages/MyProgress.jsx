...
<div className="mx-5 md:mx-10 mt-60 mb-20">
    ...
    <section className="flex gap-4 mt-4 shadow-sm border px-4 py-5 border-[#E5E7EB] rounded">
        ...
        <div>
            ...
            <p className="text-[13px] text-[#6B7280] md:w-[80%]">Learning a little each day adds up. Research shows that students who make learning a habit are more likely to reach their goals.
    ...
    <section className="mt-5">
      <div className="md:flex md:justify-between md:items-center">
        ...
        <p className="text-[13px] md:text-[14px] text-[#1E3A5F]">3 courses</p>
        <div className="flex items-center">
            <p className="text-[13px] md:text-[14px] font-semibold text-[#1E3A5F]">Recentely Accessed</p>
            <RiArrowDropDownLine className="text-2xl" />
        </div>
        </div>
    </section>
